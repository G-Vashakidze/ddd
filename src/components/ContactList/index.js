...
const ContactList = ({ contacts, onSetContacts ,onEditModal}) => {
    ...
    <table>
      ...
      <thead>
        <tr>
          ...
          <th><i className="fa fa-trash-o delete-all" onClick={handleDeleteAll} /></th>
          <th></th>
          <th>Name</th>
          <th>Phone number</th>
        </tr>
      ...
      <tbody>
        {
          contacts.map((contact, i) => <Contact onSetContacts={onSetContacts} onToggleContactFromList={toggleContactFromList} checkedIds={checkedIds} onEditModal={onEditModal} contactData={contact} key={`contact-${i}`} />)
        }
